...
{{/*
Create selector labels for PostgreSQL
*/}}
{{- define "postgresql.selectorLabels" -}}
{{ include "base.selectorLabels" . }}
app.kubernetes.io/component: {{ include "open-webui.fullname" . }}-postgresql
{{- end }}

{{/*
Create labels for PostgreSQL
*/}}
...
{{- $clusterDomain := .Values.clusterDomain -}}
{{- printf "%s-postgresql.%s.svc.%s:5432" (include "open-webui.fullname" .) (.Release.Namespace) $clusterDomain -}}
{{- end }}
