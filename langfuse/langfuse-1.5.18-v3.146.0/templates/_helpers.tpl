...
{{- printf "%s-postgresql.%s.svc.cluster.local" (include "langfuse.fullname" .) .Release.Namespace -}}
{{- end }}
{{- end }}
...
{{- printf "%s-%s-primary.%s.svc.cluster.local" (include "langfuse.fullname" .) (default "redis" .Values.redis.nameOverride) .Release.Namespace -}}
{{- end }}
{{- end }}
...
{{- printf "%s-clickhouse.%s.svc.cluster.local" (include "langfuse.fullname" .) .Release.Namespace -}}
{{- end }}
{{- end }}
...
{{- printf "http://%s-%s.%s.svc.cluster.local:9000" (include "langfuse.fullname" .) (default "s3" .Values.s3.nameOverride) .Release.Namespace -}}
{{- else }}
{{- end }}
{{- end }}
