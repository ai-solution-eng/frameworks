...
| deployments.nimDefaultGroupID | string | `nil` | Default group ID for NIM deployments (optional, only set if provided) |
| deployments.nimDefaultUserID | string | `nil` | Default user ID for NIM deployments (optional, only set if provided) |
